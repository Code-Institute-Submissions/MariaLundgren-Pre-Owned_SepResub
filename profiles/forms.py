...
class UserProfileForm(forms.ModelForm):
    ...
    phone_regex = RegexValidator(regex=r'[0-9+]$', message="You can only enter numbers and + in this field.")
    ...
    default_name = forms.CharField(validators=[num_let_regex], required=True, min_length=5)
